...
La alternativa es que estas blue stragglers se encuentren en sistemas binarios con otro objeto, el cual ha transferido parte de su material a la estrella (inicialmente con menor masa), provocando que esta se vuelva más masiva y caliente. Esta es la \textit{hipótesis de transferencia de masa binaria} \citep{wang2024bluestragglerstars}.
