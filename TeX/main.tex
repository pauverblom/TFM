...
\addto\captionsspanish{\renewcommand{\tablename}{Tabla}} % override babel's "Cuadro" → "Tabla"
...
\input{Capítulos/Resumen} %insert the chapter text from the files
...
\setlength{\headheight}{15.21004pt} %set the header height
...
\input{Capítulos/Introducción.tex}
\input{Capítulos/Hidrodinámica y Oscilaciones Estelares.tex}
\input{Capítulos/Creando Blue Stragglers.tex}
\input{Capítulos/Evolución de la Blue Straggler.tex}
\input{Capítulos/Conclusiones}
